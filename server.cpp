	...
	if (argc==2)
	{
		for (i=1;i<7;i++)
		{
			for (j=1;j<4;j++)
			{
				for (k=1;k<4;k++)
				{
					if (argv[1][(i-1)*9+(j-1)*3+k-1]=='r')
					{
						 cube[i][j][k]=1;
					}
					else if (argv[1][(i-1)*9+(j-1)*3+k-1]=='g')
					{
						 cube[i][j][k]=2;
					}
					else if (argv[1][(i-1)*9+(j-1)*3+k-1]=='w')
					{
						 cube[i][j][k]=3;
					}
					else if (argv[1][(i-1)*9+(j-1)*3+k-1]=='y')
					{
						 cube[i][j][k]=4;
					}
					else if (argv[1][(i-1)*9+(j-1)*3+k-1]=='b')
					{
						 cube[i][j][k]=5;
					}
					else if (argv[1][(i-1)*9+(j-1)*3+k-1]=='o')
					{
						 cube[i][j][k]=6;
					}
				}
